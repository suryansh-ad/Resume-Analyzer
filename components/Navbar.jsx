    ...
    <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-5">
          ...
          <Link href="/#analyzer" className="hidden text-sm text-slate-300 transition hover:text-white sm:block">
            Analyzer
          </Link>
          {user ? (
            ...
            <Link href="/#auth" className="rounded-full bg-white px-4 py-2 text-sm font-medium text-slate-950 transition hover:-translate-y-0.5">
              Sign In
            </Link>
          )}
        </div>
